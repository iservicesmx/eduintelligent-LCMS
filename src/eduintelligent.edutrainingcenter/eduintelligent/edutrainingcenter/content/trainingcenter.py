...
from eduintelligent.edutrainingcenter.config import PROJECTNAME
from eduintelligent.edutrainingcenter.interfaces import ITrainingCenter

from Products.eduTrainingCenter import TCMessageFactory as _
    ...
    def initializeArchetype(self, **kwargs):
        ...
        if 'news' not in self.objectIds():
            ...
            obj.setTitle(self.translate(
                    msgid='news_title',
                    domain='eduintelligent.edutrainingcenter',
                    default='News'))
